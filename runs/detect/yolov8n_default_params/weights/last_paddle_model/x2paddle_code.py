...
class DetectionModel(paddle.nn.Layer):
    def __init__(self):
        ...
        self.conv2d48 = paddle.nn.Conv2D(padding=1, out_channels=64, kernel_size=(3, 3), in_channels=64)
        self.silu47 = paddle.nn.Silu()
        self.conv2d49 = paddle.nn.Conv2D(padding=1, out_channels=64, kernel_size=(3, 3), in_channels=64)
        self.silu48 = paddle.nn.Silu()
        self.conv2d50 = paddle.nn.Conv2D(out_channels=2, kernel_size=(1, 1), in_channels=64)
        ...
        self.conv2d54 = paddle.nn.Conv2D(padding=1, out_channels=64, kernel_size=(3, 3), in_channels=128)
        ...
        self.conv2d56 = paddle.nn.Conv2D(out_channels=2, kernel_size=(1, 1), in_channels=64)
        ...
        self.conv2d62 = paddle.nn.Conv2D(out_channels=2, kernel_size=(1, 1), in_channels=64)
...
def main(x0):
    ...
    params = paddle.load(r'/media/yura/edbf3aee-91a2-4ee8-98ca-fb2ac8d9fc21/processing_gan/runs/detect/yolov8n_default_params/weights/last_paddle_model/model.pdparams')
